...
class ChestGraphics(QGraphicsPixmapItem):
    """
    ...
    def set_image(self):
        ...
        if self.type == 0:
            self.setPixmap(QPixmap('images/open_chest_2.png'))

        elif self.type == 1:
            self.setPixmap(QPixmap('images/closed_chest.png'))

        elif self.type == 2:
            self.setPixmap(QPixmap('images/sign.png'))
